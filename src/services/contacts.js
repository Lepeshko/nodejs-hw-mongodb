...
export const getContact = (filter) => ContactCollection.findOne(filter); // Тут була помилка ContactCollection.findById(filter); змінено на ContactCollection.findOne(filter);
